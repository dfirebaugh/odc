...
ODC_API void odc_handle_mouse_click(
	GLFWwindow *window, int button, int action, int mods);
ODC_API void odc_handle_mouse_movement(
...
ODC_API void odc_handle_mouse_movement_callback(
	GLFWwindow *window, double xpos, double ypos);
ODC_API int odc_is_mouse_button_just_pressed(GLFWwindow *window, int button);
ODC_API int odc_is_button_pressed(GLFWwindow *window, int key);
ODC_API int odc_is_mouse_button_pressed(GLFWwindow *window, int button);
